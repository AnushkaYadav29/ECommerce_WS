...
<div class="card shadow-sm h-100" style="background-color:#cab4e9; width:18rem;">
  <div class="card-body">
...
//     let cart = JSON.parse(localStorage.getItem('Cart81')) || [];

//     // total quantity 
//     let totalQty = cart.reduce((sum, item) => sum + item.quantity_inCart, 0);

//     if (cartLengthElmt) {
//         cartLengthElmt.textContent = totalQty;
//     }
// }
